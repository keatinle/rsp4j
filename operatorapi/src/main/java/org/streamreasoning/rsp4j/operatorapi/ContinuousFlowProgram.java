...
public class ContinuousFlowProgram<I, W, R, O> extends ContinuousQueryExecutionSubscriber<I, W, R, O> {

    private static final Logger log = Logger.getLogger(ContinuousFlowProgram.class);
  ...
  public ContinuousFlowProgram(ContinuousProgramBuilder builder) {
  ...
  public static class ContinuousProgramBuilder<I, W, R, O> {
    ...
    public ContinuousProgramBuilder<I, W, R, O> addTask(TaskOperatorAPIImpl<I, W, R, O> task) {
      tasks.add(task);
      return this;
    }
    ...
    public ContinuousFlowProgram<I, W, R, O> build() {
      return new ContinuousFlowProgram<I, W, R, O>(this);
    }
