...
public class CFPTriplePatternTest {
    ...
    public void simpleTPAbstractionTest() {
        ...
        StreamToRelationOp<Graph, Graph> build = new CSPARQLFlowStreamToRelationOp<Graph, Graph>(RDFUtils.createIRI("w1"), 2000, 2000,  instance, tick, report, report_grain, new GraphContentFactory(instance));
        ...
        TaskOperatorAPIImpl<Graph, Graph, Binding, Binding> t =
                new TaskOperatorAPIImpl.TaskBuilder()
                        ...
                        .build();
        ContinuousFlowProgram<Graph, Graph, Binding, Binding> cp = new ContinuousFlowProgram.ContinuousProgramBuilder()
                .in(stream)
                .addTask(t)
                .out(outStream)
                .build();
    ...
    public void simpleTPAbstractionAggregationTest() {
        ...
        StreamToRelationOp<Graph, Graph> build = new CSPARQLFlowStreamToRelationOp<>(RDFUtils.createIRI("w1"), 2000, 2000, instance, tick, report, report_grain, new GraphContentFactory(instance));
    ...
    public void triplePatternQueryNoWindowTest() {
        ...
        StreamToRelationOp<Graph, Graph> r2r = new CSPARQLFlowStreamToRelationOp<Graph, Graph>(RDFUtils.createIRI("w1"), 2000, 2000, instance, tick, report, report_grain, new GraphContentFactory(instance));
