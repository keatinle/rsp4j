...
public interface FlowStreamToRelationOp<I, W> extends Consumer<I>, StreamToRelationOp<I, W> {
    ...
    FlowStreamToRelationOp<I, W> subscribe(ContinuousQueryExecution<I, W, ?, ?> subscriber);
