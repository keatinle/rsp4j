...
public class CQELSFlowStreamToRelationOp<T1, T2> extends PublisherStreamToRelationOp<T1, T2> {

    private static final Logger log = Logger.getLogger(CQELSFlowStreamToRelationOp.class);
    ...
    public CQELSFlowStreamToRelationOp(IRI iri, long a, Time instance, Tick tick, Report report, ReportGrain grain, ContentFactory<T1, T2> cf) {
